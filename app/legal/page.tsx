      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <section id="terms" className="mb-20">
          ...
          <div className="space-y-6 text-stone-600 leading-relaxed text-sm md:text-base">
            ...
            <p>
              ...
              事業者が提供する農業の作業管理、農薬情報管理、計算補助、記録、その他農業支援を目的としたアプリケーション「TAGAYASU」をいいます。
            </p>
            <p>
        ...
        <section id="privacy">
          ...
          <div className="space-y-6 text-stone-600 leading-relaxed text-sm md:text-base">
            <p>
              寺田裕人（以下「事業者」といいます）は、
              事業者が提供する農業支援アプリケーション「TAGAYASU」および関連サービス（以下「本サービス」といいます）において取得する
